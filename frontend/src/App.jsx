...
function PlanChannelDialog({channelName,group,items,total,loading,loadingMore,hasMore,loadMore,sentinel,loadError,personName,onClose,onSelectPlan,onClearFilters,filters,setFilters,query,onQueryChange,users,statuses}) {
