...
export function WorkCalendar({data,params,go}) {
 ...
 const [selectedDay,setSelectedDay]=useState(''),[visibleMonth,setVisibleMonth]=useState(todayMonth)
